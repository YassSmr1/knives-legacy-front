...
export default class ConnectModal extends Vue {
  /***
   * Dispatch the CONNECT_METAMASK action and close the modal used to connect
   * @returns {void}
   */
  ...
  /***
   * Dispatch the CONNECT_WALLET_CONNECT action and close the modal used to connect
   * @returns {void}
   */
